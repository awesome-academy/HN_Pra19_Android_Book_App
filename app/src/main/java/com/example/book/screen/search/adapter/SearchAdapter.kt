...
class SearchAdapter(var listBook: List<Book>) : RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: ItemSearchBookBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(book: Book) {
            println("book1: $book")
